...
def process_page(image, page_idx):
    ...
    regions = [
        ...
        # Removed regions 6, 7, 8, 9, and 12
        (0, height // 3, 0, width // 3),  # Top-left quarter
        (height // 3, 2 * height // 3, width // 3, 2 * width // 3),  # Center rectangle
        ((height // 2)-700, height-1300, width//2, width-1000), 
        # Top half of new region
        (((height // 2) - 700), ((height // 2) - 700 + ((height - 1300) - ((height // 2) - 700)) // 2), width // 2, width - 1000),
    # Bottom half of new region
        (((height // 2) - 700 + ((height - 1300) - ((height // 2) - 700)) // 2), (height - 1300), width // 2, width - 1000)
]
